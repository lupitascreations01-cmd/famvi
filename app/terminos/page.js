    ...
    <main style={{ minHeight: '100vh', background: '#F8F7F4', fontFamily: 'sans-serif', padding: '2rem' }}>
      <div style={{ maxWidth: '700px', margin: '0 auto' }}>
        ...
        {[
          ...
          ['10. Modificaciones', 'Famvi se reserva el derecho de modificar estos términos en cualquier momento. Te notificaremos por correo electrónico ante cambios importantes. El uso continuado del servicio implica aceptación de los nuevos términos.'],
