  ...
  return (
    <main style={{ minHeight: '100vh', background: '#F8F7F4', fontFamily: 'sans-serif', padding: '2rem' }}>
      <div style={{ maxWidth: '700px', margin: '0 auto' }}>
        ...
        <h1 style={{ fontSize: '2rem', fontWeight: '400', color: '#1A1A2E', marginBottom: '0.5rem' }}>
        ...
        {[
          ...
          ['3. Datos de familiares', 'Los números de WhatsApp de tus familiares se usan exclusivamente para enviarles mensajes de check-in de bienestar. No los usamos para publicidad ni los compartimos con terceros. Al registrar un familiar, confirmas tener su consentimiento.'],
          ['4. Compartición de datos', 'No vendemos ni compartimos tu información personal con terceros, excepto con los proveedores de servicio necesarios para operar Famvi: Supabase (base de datos), Twilio (envío de WhatsApp), Vercel (hosting), y Lemon Squeezy (pagos). Todos operan bajo sus propias políticas de privacidad.'],
          ['5. Seguridad', 'Protegemos tu información con cifrado SSL, autenticación segura, y acceso restringido a datos. Sin embargo, ningún sistema es 100% seguro. Te recomendamos usar contraseñas seguras y no compartir tu acceso.'],
          ['6. Retención de datos', 'Conservamos tus datos mientras tu cuenta esté activa. Si cancelas tu cuenta, eliminamos tus datos personales dentro de los 30 días siguientes, excepto los que debamos conservar por obligaciones legales.'],
          ['7. Tus derechos', 'Tienes derecho a acceder a tus datos personales, corregirlos, solicitar su eliminación, y exportarlos. Para ejercer estos derechos, contáctanos en hola@famvi.app.'],
          ...
          ['10. Cambios a esta política', 'Si hacemos cambios importantes a esta política, te notificaremos por correo electrónico con al menos 7 días de anticipación.'],
